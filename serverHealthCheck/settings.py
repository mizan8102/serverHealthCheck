...
# Optionally, you can set other CORS-related settings as needed.
# For example:
# CORS_ALLOW_HEADERS = [
#     'accept',
#     'accept-encoding',
...
#     'x-requested-with',
# ]
# CORS_ALLOW_CREDENTIALS = True  # Set this to True if you want to allow cookies to be sent with the request.
